...
<html lang="en">
  ...
  <head>
    ...
    <title>Recipe Sharing  Station Portal | Search  Page</title>
...
?>
      ...
      <img class="card-img-top" src="admin/postimages/<?php echo htmlentities($row['PostImage']);?>" alt="<?php echo htmlentities($row['posttitle']);?>">
            <div class="card-body">
              ...
              <a href="recipe-details.php?nid=<?php echo htmlentities($row['pid'])?>" class="btn btn-primary">Read More &rarr;</a>
            </div>
