...
<html lang="en">
  ...
  <head>
    ...
    <title>Recipe Sharing  Station Portal | Category  Page</title>
...
?>
<h1><?php echo htmlentities($row['category']);?> recipe</h1>
          <div class="card mb-4">
       <img class="card-img-top" src="admin/postimages/<?php echo htmlentities($row['PostImage']);?>" alt="<?php echo htmlentities($row['posttitle']);?>">
            <div class="card-body">
                  <p class="text-right mb-0"><small>Posted on <?php echo htmlentities($row['postingdate']);?></small></p>
                
              <a href="recipe-details.php?nid=<?php echo htmlentities($row['pid'])?>"  class="card-title text-decoration-none text-dark"><h2 class="card-title text-dark"><?php echo htmlentities($row['posttitle']);?></h2></a>
           
              <a href="recipe-details.php?nid=<?php echo htmlentities($row['pid'])?>" class="">Read More &rarr;</a>
            </div>
